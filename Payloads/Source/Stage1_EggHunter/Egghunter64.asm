...
Mov            Rax, Qword [GS:0x8]                                             ; Stack base (highest address) - example: 0x0000000000150000
Cmp            R15, Rax
Jg             EggHunter64.Stackless
Mov            Rax, Qword [GS:0x10]                                            ; Stack limit (lowest address) - example: 0x000000000014D000
Cmp            R15, Rax
...
ResolveExportAddress64_pModuleBase                Equ -08h
ResolveExportAddress64_qwTargetFunctionHash       Equ -10h
ResolveExportAddress64_pImageExportTable          Equ -18h
ResolveExportAddress64_pdwAddressOfNames          Equ -20h
ResolveExportAddress64_pwAddressOfNameOrdinals    Equ -28h
ResolveExportAddress64_pdwAddressOfFunctions      Equ -30h
ResolveExportAddress64_qwFunctionAddress          Equ -38h
ResolveExportAddress64_dwExportTableSize          Equ -40h
ResolveExportAddress64_pForwardedModuleBase       Equ -48h
ResolveExportAddress64_ForwardedFunctionName      Equ -150h                    ; 100h is 256, clean multiple of 8 for stack alignment.
ResolveExportAddress64_ForwardedModuleName        Equ -250h
ResolveExportAddress64_StackSize                  Equ 250h
...
Push           Rbp
Mov            Rbp, Rsp
Sub            Rsp, ResolveExportAddress64_StackSize
Push           Rdi
Push           Rsi
Mov            Qword[Rbp + ResolveExportAddress64_pModuleBase], Rcx
Mov            Qword[Rbp + ResolveExportAddress64_qwTargetFunctionHash], Rdx
Xor            Rbx, Rbx
Mov            Ebx, Dword[Rcx + IMAGE_DOS_HEADER.e_lfanew]
Add            Rcx, Rbx
Add            Rcx, (IMAGE_FILE_HEADER_size + 4)
Mov            Rsi, Qword[Rbp + ResolveExportAddress64_pModuleBase]
Xor            Rbx, Rbx
Mov            Ebx, Dword[Rcx + IMAGE_OPTIONAL_HEADER64.DataDirectory]
Add            Rsi, Rbx
Mov            Qword[Rbp + ResolveExportAddress64_pImageExportTable], Rsi
Mov            Eax, Dword[Rcx + IMAGE_OPTIONAL_HEADER64.DataDirectory + 4]     ; Size field in first data directory(export address table)
Mov            Dword[Rbp + ResolveExportAddress64_dwExportTableSize], Eax
Mov            Rax, Qword[Rbp + ResolveExportAddress64_pModuleBase]
Mov            Ebx, Dword[Rsi + IMAGE_EXPORT_DIRECTORY.AddressOfNames]
Add            Rax, Rbx
Mov            Qword[Rbp + ResolveExportAddress64_pdwAddressOfNames], Rax
Mov            Rax, Qword[Rbp + ResolveExportAddress64_pModuleBase]
Xor            Rbx, Rbx
Mov            Ebx, Dword[Rsi + IMAGE_EXPORT_DIRECTORY.AddressOfNameOrdinals]
Add            Rax, Rbx
Mov            Qword[Rbp + ResolveExportAddress64_pwAddressOfNameOrdinals], Rax
Mov            Rax, Qword[Rbp + ResolveExportAddress64_pModuleBase]
Mov            Ebx, Dword[Rsi + IMAGE_EXPORT_DIRECTORY.AddressOfFunctions]
Add            Rax, Rbx
Mov            Qword[Rbp + ResolveExportAddress64_pdwAddressOfFunctions], Rax
Xor            Rsi, Rsi
Mov            Qword[Rbp + ResolveExportAddress64_qwFunctionAddress], Rsi

.GetFunctionName:                                                              ; Rsi = Current function index(should be initialized to 0)

Mov            Rax, Qword[Rbp + ResolveExportAddress64_pImageExportTable]
Mov            Eax, Dword[Rax + IMAGE_EXPORT_DIRECTORY.NumberOfNames]
Cmp            Rax, Rsi
Jbe            ResolveExportAddress64.ReturnHash
Mov            Rax, Rsi
Lea            Rcx, Qword[Rax * 4]
Mov            Rdx, Qword[Rbp + ResolveExportAddress64_pdwAddressOfNames]
Mov            Rax, Qword[Rbp + ResolveExportAddress64_pModuleBase]
...
Mov            Rcx, Rax
Call           GetStringHash64
Cmp            Eax, Dword[Rbp + ResolveExportAddress64_qwTargetFunctionHash]   ; Explicitly check 32 - bits, otherwise long function names may produce hashes which require 64 bits.
...
Mov            Rax, Qword[Rbp + ResolveExportAddress64_pwAddressOfNameOrdinals]
Movzx          Rax, Word[Rdx + Rax]
Lea            Rcx, Qword[Rax * 4]
Mov            Rdx, Qword[Rbp + ResolveExportAddress64_pdwAddressOfFunctions]
Mov            Rax, Qword[Rbp + ResolveExportAddress64_pModuleBase]
Mov            Ebx, Dword[Rcx + Rdx]
Add            Rax, Rbx
Mov            Qword[Rbp + ResolveExportAddress64_qwFunctionAddress], Rax      ; We've resolved the address of the target function. However this may be a forwarder string, not code. Check and see if the address is within the export table to determine this.
Mov            Rcx, Qword[Rbp + ResolveExportAddress64_pImageExportTable]
Mov            Rdx, Rcx
Xor            Rbx, Rbx
Mov            Ebx, Dword[Rbp + ResolveExportAddress64_dwExportTableSize]
Add            Rdx, Rbx
Cmp            Rax, Rcx
...
Mov            Qword[Rbp + ResolveExportAddress64_qwFunctionAddress], 0        ; The function address falls within the EAT.We can assume that it is a forwarder.Extract the module / function name : <Module name(no extension)>.<Function name>
%Ifdef FORWARDED_API_SUPPORT
Xor            Rcx, Rcx                                                        ; Forwarder string counter
Nop                                                                            ; Float conversion
Lea            Rbx, Qword[Rbp + ResolveExportAddress64_ForwardedModuleName]    ; Initially the buffer register will point to the module name since this field comes first.
...
Lea            Rbx, Qword[Rbp + ResolveExportAddress64_ForwardedFunctionName]  ; Switch the buffer register and begin building the function string
...
;Lea            Rdx, Qword[Rbp + ResolveExportAddress64_ForwardedFunctionName]
Xor            Rdx, Rdx
Lea            Rcx, Qword[Rbp + ResolveExportAddress64_ForwardedModuleName]
Call           GetStringHash64
Mov            Rcx, Rax
Call           GetModuleBase64
Test           Rax, Rax
...
Mov            Qword[Rbp + ResolveExportAddress64_pForwardedModuleBase], Rax
Xor            Rdx, Rdx
Lea            Rcx, Qword[Rbp + ResolveExportAddress64_ForwardedFunctionName]
Call           GetStringHash64
Mov            Rdx, Rax
Mov            Rcx, Qword[Rbp + ResolveExportAddress64_pForwardedModuleBase]
Call           ResolveExportAddress64_
Mov            Qword[Rbp + ResolveExportAddress64_qwFunctionAddress], Rax
...
Mov            Rax, Qword[Rbp + ResolveExportAddress64_qwFunctionAddress]
Pop            Rsi
Pop            Rdi
Mov            Rsp, Rbp
Pop            Rbp
